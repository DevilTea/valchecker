...
`union-large/*`, `recursion/*`, `nullish/*`, and `schema-kind/*` are `equivalent` by contrast: accepted sets, outputs, and failure positions agree exactly on every participating adapter.
