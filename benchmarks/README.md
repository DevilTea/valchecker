...
- 106 of the 167 rankable scenarios came out in a different order, and 27 named a different fastest library;
- most decisively, of the 1,232 adapter pairs the report would have presented as *separated* — a gap above 5% in both runs — 153 reversed. That is 12.4%, against the 2.3% false-mark rate the 5% threshold was calibrated to, so the bulk of it is the isolation change rather than noise.
