...
function toCatalogEntry(scenario) {
	return {
		...
		conformanceKey: scenario.comparisonScope === 'equivalent' ? scenario.conformanceKey : null,
		conformanceCaseCount: scenario.comparisonScope === 'equivalent' ? scenario.conformanceCases.length : 0,
		conformanceNoFailureReason: scenario.comparisonScope === 'equivalent' ? scenario.conformanceNoFailureReason ?? null : null,
