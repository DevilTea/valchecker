...
`fallback()` recovers validation and operation failures. Internal issues are fatal and bypass the callback. Message resolution order is in [error handling](./references/error-handling.md#message-resolution).
