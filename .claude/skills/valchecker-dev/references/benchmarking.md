...
- treats a geometric-mean regression of at least 5% across two or more *decisive* rows in one group as severe, and reports the groups that had fewer than two. Improvements count as decisive: excluding them would average regressions and cleared rows only, which is biased toward firing on a trade-off;
