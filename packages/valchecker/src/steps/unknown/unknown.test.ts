...
describe('unknown step plugin', () => {
	...
	describe('edge cases', () => {
		it('should pass for empty object', () => {
			const result = v.unknown().execute({})
		...
		it('should pass for zero', () => {
			const result = v.unknown().execute(0)
		...
		it('should handle complex nested object', () => {
			...
			const result = v.unknown().execute(complex)
			expect(result).toEqual({ value: complex })
		})

		it('should handle function', () => {
			const func = () => 'test'
			const result = v.unknown().execute(func)
			expect(result).toEqual({ value: func })
		})
	})
