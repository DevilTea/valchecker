...
export class InstanceSchema<T> extends AbstractSchema<InstanceSchemaTypes<T>> {}
 ...
 */
export function instance<T>(constructor_: (new (...args: any[]) => T), message?: InstanceSchemaMessage<T>): InstanceSchema<T> {
