...
export class NumberSchema extends AbstractSchema<NumberSchemaTypes> {}
 ...
 */
export function number(message?: NumberSchemaMessage): NumberSchema
/**
 * Creates a number schema. (accepts NaN if `allowNaN` is true)
 */
export function number(allowNaN: boolean, message?: NumberSchemaMessage): NumberSchema
