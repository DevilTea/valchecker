...
export class LiteralSchema<L extends string | number | boolean | bigint | symbol> extends AbstractSchema<LiteralSchemaTypes<L>> {}
 ...
 */
export function literal<L extends string | number | boolean | bigint | symbol>(value: L, message?: LiteralSchemaMessage<L>): LiteralSchema<L> {
