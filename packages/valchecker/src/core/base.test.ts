import type { ValidationIssue, ValidationResult } from './base'
...
describe('tests of `AbstractBaseSchema.validate`', () => {
	describe('happy path cases', () => {
		...
		describe('case 3: handles async validation returning success', () => {
			it('should return promise resolving to success', async () => {
				class TestSchema extends AbstractBaseSchema<{ async: true, transformed: false, meta: null, input: string, output: string, issueCode: 'TEST_ERROR' }> {}
...
describe('tests of `AbstractBaseSchema.isValid`', () => {
	describe('happy path cases', () => {
	...
	describe('happy path cases', () => {
		...
		describe('case 3: implements schema class with isTransformed function', () => {
			it('should set isTransformed correctly', () => {
				class TestSchema extends AbstractBaseSchema<{ async: false, transformed: true, meta: null, input: string, output: string, issueCode: 'TEST_ERROR' }> {}
