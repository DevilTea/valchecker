...
describe('boolean plugin', () => {
	describe('valid inputs', () => {
		it('should pass for true', () => {
			const result = v.boolean().execute(true)
			expect(result).toEqual({ value: true })
		})

		it('should pass for false', () => {
			const result = v.boolean().execute(false)
	...
	describe('invalid inputs', () => {
		it('should fail for number', () => {
			const result = v.boolean().execute(42)
		...
		it('should fail for string', () => {
			const result = v.boolean().execute('hello')
			expect(result).toEqual({
				issues: [{
					code: 'boolean:expected_boolean',
					payload: { value: 'hello' },
		...
		it('should fail for null', () => {
			const result = v.boolean().execute(null)
			expect(result).toEqual({
				issues: [{
					code: 'boolean:expected_boolean',
					payload: { value: null },
		...
		it('should fail for undefined', () => {
			const result = v.boolean().execute(undefined)
			expect(result).toEqual({
				issues: [{
					code: 'boolean:expected_boolean',
		...
		it('should fail for object', () => {
			const result = v.boolean().execute({})
			expect(result).toEqual({
				issues: [{
					code: 'boolean:expected_boolean',
					payload: { value: {} },
		...
		it('should fail for bigint', () => {
			const result = v.boolean().execute(123n)
			expect(result).toEqual({
				issues: [{
					code: 'boolean:expected_boolean',
					payload: { value: 123n },
		...
		it('should fail for symbol', () => {
			...
			const result = v.boolean().execute(sym)
			expect(result).toEqual({
				issues: [{
					code: 'boolean:expected_boolean',
					payload: { value: sym },
	...
	describe('custom messages', () => {
		it('should use custom message for invalid input', () => {
			const result = v.boolean('Custom error message').execute(42)
			expect(result).toEqual({
				issues: [{
					code: 'boolean:expected_boolean',
					payload: { value: 42 },
